document.getElementById('text-bold').addEventListener('click',function(event){
    // document.getElementById('main-text').style.fontWeight = 'bold'
    document.getElementById('main-text').classList.toggle('font-bold')
    buttonColor(event)
})
document.getElementById('text-italic').addEventListener('click',function(event){
    document.getElementById('main-text').classList.toggle('italic')
    buttonColor(event)
})
document.getElementById('text-underline').addEventListener('click',function(event){
